...
if(global.endlessmode)
{
	...
	if (sprite_index == spr_EasyDifficultyButton || sprite_index == spr_EasyDifficultyButtonGold || sprite_index == spr_EasyDifficultyButtonDiamond){
		...
		draw_text(x, y-175, "Strong powerups and weak enemies.");
	}
		...
		draw_text(x, y-150, "Prepare yourself in 25 Rooms before facing the Boss.");
		draw_text(x, y-175, "Moderate powerups and medium enemies.");
	}
		...
		draw_text(x, y-150, "Prepare yourself in 30 Rooms before facing the Boss.");
		draw_text(x, y-175, "Weak powerups and strong enemies.");
	}
}
